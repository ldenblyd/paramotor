const Privacy: React.FC = () => {
  return (
    <div>
      <h1>Privacy Policy for codeeli</h1>

      <p>
        At youfly, accessible from https://youfly.io, one of our main priorities
        is the privacy of our visitors. This Privacy Policy document contains
        types of information that is collected and recorded by youfly and how we
        use it.
      </p>
      ...
      <p>
        ...
        shared and/or collect in youfly. This policy is not applicable to any
      ...
      <p>
        youfly follows a standard procedure of using log files. These files log
      ...
      <p>
        Like any other website, youfly uses 'cookies'. These cookies are used to
      ...
      <p>
        ...
        advertising partners of youfly.
      </p>

      <p>
        Third-party ad servers or ad networks uses technologies like cookies,
        JavaScript, or Web Beacons that are used in their respective
        advertisements and links that appear on youfly, which are sent directly
      ...
      <p>
        Note that youfly has no access to or control over these cookies that are
      ...
      <p>
        youfly's Privacy Policy does not apply to other advertisers or websites.
      ...
      <p>
        youfly does not knowingly collect any Personal Identifiable Information
